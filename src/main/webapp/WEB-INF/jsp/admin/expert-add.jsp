...
<div class="layui-layout layui-layout-admin">
  	...
  	<div class="layui-body">
	    ...
	    <form class="layui-form" action="saveexpert" method="post" onsubmit="getEditor();">
		  ...
		  <div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      <input type="text" name="expertTitle" required  lay-verify="required" autocomplete="off" class="layui-input">
		    </div>
		  </div>
		  <div class="layui-form-item">
		  ...
		  <div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      <input type="text" name="birth" required  lay-verify="required" autocomplete="off" class="layui-input">
		    </div>
		  </div>
		  <div class="layui-form-item">
