	...
	<!-- 左侧菜单 -->
  	...
  	<div class="layui-body">
	    ...
	    <div class="layui-card">
		  <div class="layui-card-header layui-bg-green">供应商企业信息</div>
		  <div class="layui-card-body">
		  	<form action="/ssm/sup/updatesup" method="post">
		    <table class="layui-table">
			  <tbody>
			    <tr>
			      <td style="width: 150px;" class="table-meta">企业名称</td>
			      <td><input type="text"  class="layui-input" value="${sup.entName }" name="entName"></td>
			    </tr>
			    <tr>
			      <td class="table-meta">登录账号</td>
			      <td><input type="text"  class="layui-input" value="${sup.userName }" name="userName"></td>
			    </tr>
			    <tr>
			      <td class="table-meta">电话号码</td>
			      <td><input type="text"  class="layui-input" value="${sup.tel }" name="tel"></td>
			    </tr>
			    <tr>
			      <td class="table-meta">邮箱地址</td>
			      <td><input type="text"  class="layui-input" value="${sup.email }" name="email"></td>
			    </tr>
			    <tr>
			      <td class="table-meta">法人代表</td>
			      <td><input type="text"  class="layui-input" value="${sup.frdb }" name="frdb"></td>
			    </tr>
			    <tr>
			      <td class="table-meta">统一社会信用代码</td>
			      <td><input type="text"  class="layui-input" value="${sup.taxCode }" name="taxCode"></td>
			    </tr>
			    <tr>
			      <td class="table-meta">注册资金</td>
			      <td><input type="text"  class="layui-input" value="${sup.regAmount }" name="regAmount"></td>
			    </tr>
			    <tr>
			      <td class="table-meta">营业地址</td>
			      <td><input type="text"  class="layui-input" value="${sup.address }" name="address"></td>
			    </tr>
			    <tr>
			      <td class="table-meta">公司简介</td>
			      <td><input type="text"  class="layui-input" value="${sup.entDesc }" name="entDesc"></td>
			    </tr>
			    <tr>
	  			...
	  			<tr>
	  				...
	  				<td>
	  					<input type="hidden" value="${sup.supplierId }" name="supplierId">
	  					<input type="hidden" value="${sup.status }" name="status">
