...
<body layadmin-themealias="default">
	...
	<div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="display: none; margin-top: -90px;">
		...
		<div class="layadmin-user-login-main">
			...
			<form action="/ssm/ent/loginform" method="post">
			<div class="layadmin-user-login-box layadmin-user-login-body layui-form">
				...
				<div class="layui-form-item" style="text-align: center;">
					<button class="layui-btn" type="submit" lay-submit="" lay-filter="LAY-user-login-submit" style="width: 45%;"><i class="layui-icon">&#xe673;</i>&nbsp;登入</button>
					<a class="layui-btn layui-btn-normal" href="/ssm/ent/regist" style="width: 45%;"><i class="layui-icon">&#xe6b2;</i>&nbsp;注册</a>
				</div>
			</div>
			</form>
		</div>
