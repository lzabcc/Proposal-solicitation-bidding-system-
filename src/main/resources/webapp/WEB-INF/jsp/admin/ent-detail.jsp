...
<div class="layui-layout layui-layout-admin">
  	...
  	<div class="layui-body">
	    ...
	    <div class="layui-card">
		  	<div class="layui-card-header layui-bg-green" style="font-size: 18px;">征集方档案：${ent.enterpriseName }</div>
		  	<div class="layui-card-body">
		  		<table class="layui-table">
			  		<tbody>
			  			<tr>
			  				<td class="table-meta" style="width: 200px;">企业名称</td>
			  				<td>${ent.enterpriseName }</td>
			  			</tr>
			  			<tr>
			  			...
			  			<tr>
			  				...
			  				<td>
			  					<a type="button" class="layui-btn layui-btn-sm" href="/ssm/upload/${ent.attachment }">
			  			...
			  			<c:if test="${ent.status eq -1 }">
			  				<tr>
				  				<td class="table-meta">操作</td>
				  				<td>
				  					<a class="layui-btn layui-btn-xs layui-btn-normal" href="javascript:void(0);" onclick="act(${ent.entId });"><i class="layui-icon">&#xe605;</i>激活</a>
				  				</td>
				  			</tr>
			  			</c:if>
			  			<tr>
