  	...
  	<div class="layui-body">
	    ...
	    <div class="bread-nav">
	    	<span class="layui-breadcrumb">
			  ...
			  <a href="/ssm/ent/profile">个人中心</a>
			  <a href="#">修改信息</a>
			</span>
	    </div>
	    <form class="layui-form" action="/ssm/ent/updatepwd" method="post" onsubmit="return dbcheck();">
		  <div class="layui-form-item">
		    <label class="layui-form-label">企业名称</label>
		    <div class="layui-input-block">
		      <input type="text" disabled="disabled" class="layui-input" value="${ent.enterpriseName }">
		    </div>
		  </div>
		  <div class="layui-form-item">
		    <label class="layui-form-label">用户名</label>
		    <div class="layui-input-block">
		      <input type="text" disabled="disabled" class="layui-input" value="${ent.userName }">
		    </div>
		  </div>
		  <div class="layui-form-item">
		    <label class="layui-form-label">用户名</label>
