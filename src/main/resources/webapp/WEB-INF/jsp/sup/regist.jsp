  ...
  <style type="text/css">
    ...
    color: #666;}
			...
			a:hover{
 			...
 			.layui-input-block .layui-input{width: 300px;}v
        </style>
    </head>
    <body>
	<form class="layui-form" action="/ssm/sup/regform" method="post" onsubmit="return dbcheck();" enctype="multipart/form-data">
		<div class="container">
			<h3 class="ftitle">供应商注册</h3>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="entName" required lay-verify="required" placeholder="企业名称" autocomplete="off" class="layui-input">
				</div>
			</div>
